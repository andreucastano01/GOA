    ...
    std::vector<Shape*>*& objectsList, std::vector<PointLightSource>*& lightSourceList)
{
    ...
    /* Materials */
    /* ********* */
    Material* redDiffuse = new PhongMaterial(Vector3D(0.7, 0.2, 0.3), Vector3D(0, 0, 0), 100);
    Material* greenDiffuse = new PhongMaterial(Vector3D(0.2, 0.7, 0.3), Vector3D(0, 0, 0), 100);
    Material* greyDiffuse = new PhongMaterial(Vector3D(0.8, 0.8, 0.8), Vector3D(0, 0, 0), 100);
    Material* blueDiffuse = new PhongMaterial(Vector3D(0.3, 0.2, 0.7), Vector3D(0, 0, 0), 100);
    ...
    Material* red_100 = new PhongMaterial(Vector3D(0.7, 0.2, 0.3), Vector3D(0.7, 0.7, 0.2), 100);
...
int main()
{
    ...
    Shader* shader = new GlobalShader(Vector3D(0.4));
